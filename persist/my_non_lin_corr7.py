...
#Давайте не будем смотреть этот файл, он на половину мой, на половину Татарникова :)
#Ну или хотя бы я не буду переделывать на os.path.join()
#Я его добавил, что можно было уже на исправленный файл посмотреть. так как оно как раз складывает все считывания матрицы в один файл.
